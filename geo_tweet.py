    ...
    fname = '/home/imaganar/Documentos/Tweets/Codigo/extraerTweets/data/stream__lopezobrador_.json'
    ...
    with open('/home/imaganar/Documentos/Tweets/Codigo/extraerTweets/data/stream__lopezobrador_geo.json', 'w') as fout:
